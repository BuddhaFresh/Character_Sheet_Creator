...
void BRP_human_base::consoleChar()
{
  ...
  std::cout << "COMMUNICATION " << DD(Communication_skillcategory) << "%" << std::setw(22) << std::setfill(' ') << "MENTAL " << DD(Mental_skillcategory) << "%" << std::setw(31) << std::setfill(' ') << "PHYSICAL " << DD(Physical_skillcategory) << "%" << std::endl;
  ...
  std::cout << SkillTable["Command"].SkillName << " (" << DD(SkillTable["Command"].SkillBase) << ")" << std::setw(12) << std::setfill('.') << "" << DD(SkillTable["Command"].SkillMod) << "%" << std::setw(14) << std::setfill(' ') << SkillTable["First Aid"].SkillName << " (" << DD(SkillTable["First Aid"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["First Aid"].SkillMod) << "%" << std::setw(10) << std::setfill(' ') << SkillTable["Drive0"].SkillName << " (" << DD(SkillTable["Drive0"].SkillBase) << ")" << " " << SkillTable["Drive0"].SubSkillName << std::setw(13-SkillTable["Drive0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Drive0"].SkillMod) << "%" << std::endl;

  //Disguise    Gaming    Drive(subskill1)
  std::cout << SkillTable["Disguise"].SkillName << " (" << DD(SkillTable["Disguise"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Disguise"].SkillMod) << "%" << std::setw(11) << std::setfill(' ') << SkillTable["Gaming"].SkillName << " (" << DD(SkillTable["Gaming"].SkillBase) << ")" << std::setw(13) << std::setfill('.') << "" << DD(SkillTable["Gaming"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Drive1"].SubSkillName << std::setw(22-SkillTable["Drive1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Drive1"].SkillMod) << "%" << std::endl;

  //Etiquette    Knowledge(name)    Drive(subskill2)
  std::cout << SkillTable["Etiquette"].SkillName << " (" << DD(SkillTable["Etiquette"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Etiquette"].SkillMod) << "%" << std::setw(14) << std::setfill(' ') << SkillTable["Knowledge0"].SkillName << " (" << DD(SkillTable["Knowledge0"].SkillBase) << ")" << std::setw(20) << std::setfill(' ') << "  " << SkillTable["Drive2"].SubSkillName << std::setw(22-SkillTable["Drive2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Drive2"].SkillMod) << "%" << std::endl;

  //Fast Talk    Knowledge(subskill0)    Fly
  std::cout << SkillTable["Fast Talk"].SkillName << " (" << DD(SkillTable["Fast Talk"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Fast Talk"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Knowledge0"].SubSkillName << std::setw(22-SkillTable["Knowledge0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Knowledge0"].SkillMod) << "%" << std::setw(8) << std::setfill(' ') << SkillTable["Fly"].SkillName << " (" << DD(SkillTable["Fly"].SkillBase) << ")" << std::setw(16) << std::setfill('.') << "" << DD(SkillTable["Fly"].SkillMod) << "%" << std::endl;

  //Lanugae(name)    Knowledge(subskill1)    Hide
  std::cout << SkillTable["Language0"].SkillName << " (" << SkillTable["Language0"].SkillBase << ")" << std::setw(19) << std::setfill(' ') << "" << "  " << SkillTable["Knowledge1"].SubSkillName << std::setw(22-SkillTable["Knowledge1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Knowledge1"].SkillMod) << "%" << std::setw(9) << std::setfill(' ') << SkillTable["Hide"].SkillName << " (" << DD(SkillTable["Hide"].SkillBase) << ")" << std::setw(15) << std::setfill('.') << "" << DD(SkillTable["Hide"].SkillMod) << "%" << std::endl;

  //Language(subskill0)    Knowledge(subskill2)    Jump
  std::cout << "  " << SkillTable["Language0"].SubSkillName << std::setw(22-SkillTable["Language0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Language0"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Knowledge2"].SubSkillName << std::setw(22-SkillTable["Knowledge2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Knowledge2"].SkillMod) << "%" << std::setw(9) << std::setfill(' ') << SkillTable["Jump"].SkillName << " (" << DD(SkillTable["Jump"].SkillBase) << ")" << std::setw(15) << std::setfill('.') << "" << DD(SkillTable["Jump"].SkillMod) << "%" << std::endl;

  //Language(subskill1)    Literacy    Pilot(subskill0)
  std::cout << "  " << SkillTable["Language1"].SubSkillName << std::setw(22-SkillTable["Language1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Language1"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Literacy"].SkillName << " (" << DD(SkillTable["Language0"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Language0"].SkillMod) << "%" << std::setw(10) << std::setfill(' ') << SkillTable["Pilot0"].SkillName << " (" << DD(SkillTable["Pilot0"].SkillBase) << ")" << " " << SkillTable["Pilot0"].SubSkillName << std::setw(13-SkillTable["Pilot0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Pilot0"].SkillMod) << "%" << std::endl;

  //Language(subskill2)    Medicine    Pilot(subskill1)
  std::cout << "  " << SkillTable["Language2"].SubSkillName << std::setw(22-SkillTable["Language2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Language2"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Medicine"].SkillName << " (" << DD(SkillTable["Medicine"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Medicine"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << "  " << SkillTable["Pilot1"].SubSkillName << std::setw(22-SkillTable["Pilot1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Pilot1"].SkillMod) << "%" << std::endl;

  //Language(subskill3)    Psychotherapy    Pilot(subskill2)
  std::cout << "  " << SkillTable["Language3"].SubSkillName << std::setw(22-SkillTable["Language3"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Language3"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Psychotherapy"].SkillName << " (" << DD(SkillTable["Psychotherapy"].SkillBase) << ")" << std::setw(6) << std::setfill('.') << "" << DD(SkillTable["Psychotherapy"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << "  " << SkillTable["Pilot2"].SubSkillName << std::setw(22-SkillTable["Pilot2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Pilot2"].SkillMod) << "%" << std::endl;

  //Preform    Science(subskill0)    Projection
  std::cout << SkillTable["Preform"].SkillName << " (" << DD(SkillTable["Preform"].SkillBase) << ")" << std::setw(12) << std::setfill('.') << "" << DD(SkillTable["Preform"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Science0"].SkillName << " (" << DD(SkillTable["Science0"].SkillBase) << ")" << " " << SkillTable["Science0"].SubSkillName << std::setw(11-SkillTable["Science0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science0"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Projection"].SkillName << " (" << DD(SkillTable["Projection"].SkillBase) << ")" << std::setw(9) << std::setfill('.') << "" << DD(SkillTable["Projection"].SkillMod) << "%" << std::endl;

  //Persuade    Science(subskill1)    Ride(subskill0)
  std::cout << SkillTable["Persuade"].SkillName << " (" << DD(SkillTable["Persuade"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Persuade"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science1"].SubSkillName << std::setw(22-SkillTable["Science1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science1"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Ride0"].SkillName << " (" << DD(SkillTable["Ride0"].SkillBase) << ")" << " " << SkillTable["Ride0"].SubSkillName << std::setw(14-SkillTable["Ride0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Ride0"].SkillMod) << "%" << std::endl;

  //Status    Science(subskill2)    Ride(subskill1)
  std::cout << SkillTable["Status"].SkillName << " (" << DD(SkillTable["Status"].SkillBase) << ")" << std::setw(13) << std::setfill('.') << "" << DD(SkillTable["Status"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science2"].SubSkillName << std::setw(22-SkillTable["Science2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science2"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << "  " << SkillTable["Ride1"].SubSkillName << std::setw(22-SkillTable["Ride1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Ride1"].SkillMod) << "%" << std::endl;

  //Teach    Science(subskill3)    Stealth
  std::cout << SkillTable["Teach"].SkillName << " (" << DD(SkillTable["Teach"].SkillBase) << ")" << std::setw(14) << std::setfill('.') << "" << DD(SkillTable["Teach"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science3"].SubSkillName << std::setw(22-SkillTable["Science3"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science3"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Stealth"].SkillName << " (" << DD(SkillTable["Stealth"].SkillBase) << ")" << std::setw(12) << std::setfill('.') << "" << DD(SkillTable["Stealth"].SkillMod) << "%" << std::endl;

  //BLANK_SPACE    Strategy    Swim
  std::cout << std::setw(32) << std::setfill(' ') << "" << SkillTable["Strategy"].SkillName << " (" << DD(SkillTable["Strategy"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Strategy"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Swim"].SkillName << " (" << DD(SkillTable["Swim"].SkillBase) << ")" << std::setw(15) << std::setfill('.') << "" << DD(SkillTable["Swim"].SkillMod) << "%" << std::endl;

  //MANIPULATION    Technical Skill(subskill0)    Throw
  std::cout << "MANIPULATION " << DD(Manipulation_skillcategory) << "%" << std::setw(16) << std::setfill(' ') << "  " << SkillTable["Technical Skill0"].SkillName << " (" << DD(SkillTable["Technical Skill0"].SkillBase) << ")" << " " << SkillTable["Technical Skill0"].SubSkillName << std::setw(9-SkillTable["Technical Skill0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Technical Skill0"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Throw"].SkillName << " (" << DD(SkillTable["Throw"].SkillBase) << ")" << std::setw(14) << std::setfill('.') << "" << DD(SkillTable["Throw"].SkillMod) << "%" << std::endl;

  //Art(subskill0)    Technical Skill(subskill1)    BLANK_SPACE
  std::cout << SkillTable["Art0"].SkillName << " (" << DD(SkillTable["Art0"].SkillBase) << ")" << " " << SkillTable["Art0"].SubSkillName << std::setw(15-SkillTable["Art0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Art0"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill1"].SubSkillName << std::setw(22-SkillTable["Technical Skill1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Technical Skill1"].SkillMod) << "%" << std::endl;

  //Art(subskill1)    Technical Skill(subskill2)    COMBAT
  std::cout << "  " << SkillTable["Art1"].SubSkillName << std::setw(22-SkillTable["Art1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Art1"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill2"].SubSkillName << std::setw(22-SkillTable["Technical Skill2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Technical Skill2"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << "COMBAT " << DD(Combat_skillcategory) << "%" << std::endl;

  //Craft(subskill0)    BLANK_SPACE    Dodge
  std::cout << SkillTable["Craft0"].SkillName << " (" << DD(SkillTable["Craft0"].SkillBase) << ")" << " " << SkillTable["Craft0"].SubSkillName << std::setw(13-SkillTable["Craft0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Craft0"].SkillMod) << "%" << std::setw(42) << std::setfill(' ') << SkillTable["Dodge"].SkillName << " (" << DD(SkillTable["Dodge"].SkillBase) << ")" << std::setw(14) << std::setfill('.') << "" << DD(SkillTable["Dodge"].SkillMod) << "%" << std::endl;

  //Craft(subskill1)    PERCEPTION    Martial Arts
  std::cout << "  " << SkillTable["Craft1"].SubSkillName << std::setw(22-SkillTable["Craft1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Craft1"].SkillMod) << "%" << std::setw(16) << std::setfill(' ') << "PERCEPTION " << DD(Perception_skillcategory) << "%" << std::setw(30) << std::setfill(' ') << SkillTable["Martial Arts"].SkillName << " (" << DD(SkillTable["Martial Arts"].SkillBase) << ")" << std::setw(7) << std::setfill('.') << "" << DD(SkillTable["Martial Arts"].SkillMod) << "%" << std::endl;
