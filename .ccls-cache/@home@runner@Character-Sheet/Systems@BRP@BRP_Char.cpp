...
void BRP_human_base::Skills(int x, int i, int p){  
  ...
  SkillTable["Heavy Machine"] = { "Heavy Machine", "", 1, 0, Manipulation_skillcategory};
...
void BRP_human_base::consoleChar()
{
  ...
  std::cout << "COMMUNICATION " << DD(Communication_skillcategory) << "%" << std::setw(19) << std::setfill(' ') << "" << "MENTAL " << DD(Mental_skillcategory) << "%" << std::setw(26) << std::setfill(' ') << "" << "PHYSICAL " << DD(Physical_skillcategory) << "%" << std::endl;

  //Bargain    Appraise    Climb
  std::cout << SkillTable["Bargain"].SkillName << " (" << DD(SkillTable["Bargain"].SkillBase) << ")" << std::setw(12-Toolong(SkillTable["Bargain"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Bargain"].SkillMod) << "% [ ]" << std::setw(13) << std::setfill(' ') << SkillTable["Appraise"].SkillName << " (" << DD(SkillTable["Appraise"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Appraise"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Appraise"].SkillMod) << "% [ ]" << std::setw(10) << std::setfill(' ') << SkillTable["Climb"].SkillName << " (" << DD(SkillTable["Climb"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Climb"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Climb"].SkillMod) << "% [ ]" <<  std::endl;

  //Command    First Aid    Drive(subskill0)
  std::cout << SkillTable["Command"].SkillName << " (" << DD(SkillTable["Command"].SkillBase) << ")" << std::setw(12-Toolong(SkillTable["Command"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Command"].SkillMod) << "% [ ]" << std::setw(14) << std::setfill(' ') << SkillTable["First Aid"].SkillName << " (" << DD(SkillTable["First Aid"].SkillBase) << ")" << std::setw(10-Toolong(SkillTable["First Aid"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["First Aid"].SkillMod) << "% [ ]" << std::setw(10) << std::setfill(' ') << SkillTable["Drive0"].SkillName << " (" << DD(SkillTable["Drive0"].SkillBase) << ")" << " " << SkillTable["Drive0"].SubSkillName << std::setw(13-SkillTable["Drive0"].SubSkillName.length()-Toolong(SkillTable["Drive0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Drive0"].SkillMod) << "% [ ]" << std::endl;

  //Disguise    Gaming    Drive(subskill1)
  std::cout << SkillTable["Disguise"].SkillName << " (" << DD(SkillTable["Disguise"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Disguise"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Disguise"].SkillMod) << "% [ ]" << std::setw(11) << std::setfill(' ') << SkillTable["Gaming"].SkillName << " (" << DD(SkillTable["Gaming"].SkillBase) << ")" << std::setw(13-Toolong(SkillTable["Gaming"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Gaming"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Drive1"].SubSkillName << std::setw(22-SkillTable["Drive1"].SubSkillName.length()-Toolong(SkillTable["Drive1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Drive1"].SkillMod) << "% [ ]" << std::endl;

  //Etiquette    Knowledge(name)    Drive(subskill2)
  std::cout << SkillTable["Etiquette"].SkillName << " (" << DD(SkillTable["Etiquette"].SkillBase) << ")" << std::setw(10-Toolong(SkillTable["Etiquette"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Etiquette"].SkillMod) << "% [ ]" << std::setw(14) << std::setfill(' ') << SkillTable["Knowledge0"].SkillName << " (" << DD(SkillTable["Knowledge0"].SkillBase) << ")" << std::setw(22) << std::setfill(' ') << "" << "  " << SkillTable["Drive2"].SubSkillName << std::setw(22-SkillTable["Drive2"].SubSkillName.length()-Toolong(SkillTable["Drive2"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Drive2"].SkillMod) << "% [ ]" << std::endl;

  //Fast Talk    Knowledge(subskill0)    Fly
  std::cout << SkillTable["Fast Talk"].SkillName << " (" << DD(SkillTable["Fast Talk"].SkillBase) << ")" << std::setw(10-Toolong(SkillTable["Fast Talk"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Fast Talk"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Knowledge0"].SubSkillName << std::setw(22-SkillTable["Knowledge0"].SubSkillName.length()-Toolong(SkillTable["Knowledge0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Knowledge0"].SkillMod) << "% [ ]" << std::setw(8) << std::setfill(' ') << SkillTable["Fly"].SkillName << " (" << DD(SkillTable["Fly"].SkillBase) << ")" << std::setw(16-Toolong(SkillTable["Fly"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Fly"].SkillMod) << "% [ ]" << std::endl;

  //Lanugae(name)    Knowledge(subskill1)    Hide
  std::cout << SkillTable["Language0"].SkillName << " (" << SkillTable["Language0"].SkillBase << ")" << std::setw(23) << std::setfill(' ') << "" << "  " << SkillTable["Knowledge1"].SubSkillName << std::setw(22-SkillTable["Knowledge1"].SubSkillName.length()-Toolong(SkillTable["Knowledge1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Knowledge1"].SkillMod) << "% [ ]" << std::setw(9) << std::setfill(' ') << SkillTable["Hide"].SkillName << " (" << DD(SkillTable["Hide"].SkillBase) << ")" << std::setw(15-Toolong(SkillTable["Hide"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Hide"].SkillMod) << "% [ ]" << std::endl;
  ...
  std::cout << "  " << SkillTable["Language3"].SubSkillName << std::setw(22-SkillTable["Language3"].SubSkillName.length()-Toolong(SkillTable["Language3"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Language3"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Psychotherapy"].SkillName << " (" << DD(SkillTable["Psychotherapy"].SkillBase) << ")" << std::setw(6-Toolong(SkillTable["Psychotherapy"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Psychotherapy"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << "  " << SkillTable["Pilot2"].SubSkillName << std::setw(22-SkillTable["Pilot2"].SubSkillName.length()-Toolong(SkillTable["Pilot2"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Pilot2"].SkillMod) << "% [ ]" << std::endl;

  //Preform    Science(subskill0)    Projection
  std::cout << SkillTable["Preform"].SkillName << " (" << DD(SkillTable["Preform"].SkillBase) << ")" << std::setw(12-Toolong(SkillTable["Preform"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Preform"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Science0"].SkillName << " (" << DD(SkillTable["Science0"].SkillBase) << ")" << " " << SkillTable["Science0"].SubSkillName << std::setw(11-SkillTable["Science0"].SubSkillName.length()-Toolong(SkillTable["Science0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Science0"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Projection"].SkillName << " (" << DD(SkillTable["Projection"].SkillBase) << ")" << std::setw(9-Toolong(SkillTable["Projection"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Projection"].SkillMod) << "% [ ]" << std::endl;

  //Persuade    Science(subskill1)    Ride(subskill0)
  std::cout << SkillTable["Persuade"].SkillName << " (" << DD(SkillTable["Persuade"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Persuade"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Persuade"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science1"].SubSkillName << std::setw(22-SkillTable["Science1"].SubSkillName.length()-Toolong(SkillTable["Science1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Science1"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Ride0"].SkillName << " (" << DD(SkillTable["Ride0"].SkillBase) << ")" << " " << SkillTable["Ride0"].SubSkillName << std::setw(14-SkillTable["Ride0"].SubSkillName.length()-Toolong(SkillTable["Ride0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Ride0"].SkillMod) << "% [ ]" << std::endl;

  //Status    Science(subskill2)    Ride(subskill1)
  std::cout << SkillTable["Status"].SkillName << " (" << DD(SkillTable["Status"].SkillBase) << ")" << std::setw(13-Toolong(SkillTable["Status"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Status"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science2"].SubSkillName << std::setw(22-SkillTable["Science2"].SubSkillName.length()-Toolong(SkillTable["Science2"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Science2"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << "  " << SkillTable["Ride1"].SubSkillName << std::setw(22-SkillTable["Ride1"].SubSkillName.length()-Toolong(SkillTable["Ride1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Ride1"].SkillMod) << "% [ ]" << std::endl;

  //Teach    Science(subskill3)    Stealth
  std::cout << SkillTable["Teach"].SkillName << " (" << DD(SkillTable["Teach"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Teach"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Teach"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science3"].SubSkillName << std::setw(22-SkillTable["Science3"].SubSkillName.length()-Toolong(SkillTable["Science3"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Science3"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Stealth"].SkillName << " (" << DD(SkillTable["Stealth"].SkillBase) << ")" << std::setw(12-Toolong(SkillTable["Stealth"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Stealth"].SkillMod) << "% [ ]" << std::endl;

  //BLANK_SPACE    Strategy    Swim
  std::cout << std::setw(36) << std::setfill(' ') << "" << SkillTable["Strategy"].SkillName << " (" << DD(SkillTable["Strategy"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Strategy"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Strategy"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Swim"].SkillName << " (" << DD(SkillTable["Swim"].SkillBase) << ")" << std::setw(15-Toolong(SkillTable["Swim"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Swim"].SkillMod) << "% [ ]" << std::endl;

  //MANIPULATION    Technical Skill(subskill0)    Throw
  std::cout << "MANIPULATION " << DD(Manipulation_skillcategory) << "%" << std::setw(20) << std::setfill(' ') << "  " << SkillTable["Technical Skill0"].SkillName << " (" << DD(SkillTable["Technical Skill0"].SkillBase) << ")" << " " << SkillTable["Technical Skill0"].SubSkillName << std::setw(9-SkillTable["Technical Skill0"].SubSkillName.length()-Toolong(SkillTable["Technical Skill0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Technical Skill0"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Throw"].SkillName << " (" << DD(SkillTable["Throw"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Throw"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Throw"].SkillMod) << "% [ ]" << std::endl;

  //Art(subskill0)    Technical Skill(subskill1)    BLANK_SPACE
  std::cout << SkillTable["Art0"].SkillName << " (" << DD(SkillTable["Art0"].SkillBase) << ")" << " " << SkillTable["Art0"].SubSkillName << std::setw(15-SkillTable["Art0"].SubSkillName.length()-Toolong(SkillTable["Art0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Art0"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill1"].SubSkillName << std::setw(22-SkillTable["Technical Skill1"].SubSkillName.length()-Toolong(SkillTable["Technical Skill1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Technical Skill1"].SkillMod) << "% [ ]" << std::endl;

  //Art(subskill1)    Technical Skill(subskill2)    COMBAT
  std::cout << "  " << SkillTable["Art1"].SubSkillName << std::setw(22-SkillTable["Art1"].SubSkillName.length()-Toolong(SkillTable["Art1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Art1"].SkillMod) << "% [ ]" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill2"].SubSkillName << std::setw(22-SkillTable["Technical Skill2"].SubSkillName.length()-Toolong(SkillTable["Technical Skill2"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Technical Skill2"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << "COMBAT " << DD(Combat_skillcategory) << "%" << std::endl;

  //Craft(subskill0)    BLANK_SPACE    Dodge
  std::cout << SkillTable["Craft0"].SkillName << " (" << DD(SkillTable["Craft0"].SkillBase) << ")" << " " << SkillTable["Craft0"].SubSkillName << std::setw(13-SkillTable["Craft0"].SubSkillName.length()-Toolong(SkillTable["Craft0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Craft0"].SkillMod) << "% [ ]" << std::setw(46) << std::setfill(' ') << SkillTable["Dodge"].SkillName << " (" << DD(SkillTable["Dodge"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Dodge"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Dodge"].SkillMod) << "% [ ]" << std::endl;

  //Craft(subskill1)    PERCEPTION    Martial Arts
  std::cout << "  " << SkillTable["Craft1"].SubSkillName << std::setw(22-SkillTable["Craft1"].SubSkillName.length()-Toolong(SkillTable["Craft1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Craft1"].SkillMod) << "% [ ]" << std::setw(16) << std::setfill(' ') << "PERCEPTION " << DD(Perception_skillcategory) << "%" << std::setw(34) << std::setfill(' ') << SkillTable["Martial Arts"].SkillName << " (" << DD(SkillTable["Martial Arts"].SkillBase) << ")" << std::setw(7-Toolong(SkillTable["Martial Arts"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Martial Arts"].SkillMod) << "% [ ]" << std::endl;

  //Demolition    Insight    TEXT
  std::cout << SkillTable["Demolition"].SkillName << " (" << DD(SkillTable["Demolition"].SkillBase) << ")" << std::setw(9-Toolong(SkillTable["Demolition"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Demolition"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Insight"].SkillName << " (" << DD(SkillTable["Insight"].SkillBase) << ")" << std::setw(12-Toolong(SkillTable["Insight"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Insight"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << "See Weapons below for more Combat skills" << std::endl;

  //Fine Manipulation    Listen    BLANK_SPACE
  std::cout << SkillTable["Fine Manipulation"].SkillName << " (" << DD(SkillTable["Fine Manipulation"].SkillBase) << ")" << std::setw(2-Toolong(SkillTable["Fine Manipulation"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Fine Manipulation"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Listen"].SkillName << " (" << DD(SkillTable["Listen"].SkillBase) << ")" << std::setw(13-Toolong(SkillTable["Listen"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Listen"].SkillMod) << "% [ ]" << std::endl;

  //Heavy Machine(name)    Navigate    Combat Skill(ARMS0)
  std::cout << SkillTable["Heavy Machine"].SkillName << " (" << DD(SkillTable["Heavy Machine"].SkillBase) << ")" << std::setw(18) << std::setfill(' ') << "" << SkillTable["Navigate"].SkillName << " (" << DD(SkillTable["Navigate"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Navigate"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Navigate"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["ARMS0"].SkillName << " (" << DD(SkillTable["ARMS0"].SkillBase) << ")" << " " << SkillTable["ARMS0"].SubSkillName << std::setw(18-SkillTable["ARMS0"].SkillName.length()-SkillTable["ARMS0"].SubSkillName.length()-Toolong(SkillTable["ARMS0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["ARMS0"].SkillMod) << "% [ ]" << std::endl;

  //Heavy Machine(subskill0)    Research    Combat Skill(ARMS1)
  std::cout << "  " << SkillTable["Heavy Machine"].SubSkillName << std::setw(22-SkillTable["Heavy Machine"].SubSkillName.length()-Toolong(SkillTable["Heavy Machine"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Heavy Machine"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Research"].SkillName << " (" << DD(SkillTable["Research"].SkillBase) << ")" << std::setw(11-Toolong(SkillTable["Research"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Research"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["ARMS1"].SkillName << " (" << DD(SkillTable["ARMS1"].SkillBase) << ")" << " " << SkillTable["ARMS1"].SubSkillName << std::setw(18-SkillTable["ARMS1"].SkillName.length()-SkillTable["ARMS1"].SubSkillName.length()-Toolong(SkillTable["ARMS1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["ARMS1"].SkillMod) << "% [ ]" << std::endl;

  //Repair(subskill0)    Sense    Combat Skill(ARMS2)
  std::cout << SkillTable["Repair0"].SkillName << " (" << DD(SkillTable["Repair0"].SkillBase) << ")" << " " << SkillTable["Repair0"].SubSkillName << std::setw(12-SkillTable["Repair0"].SubSkillName.length()-Toolong(SkillTable["Repair0"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Repair0"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Sense"].SkillName << " (" << DD(SkillTable["Sense"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Sense"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Sense"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["ARMS2"].SkillName << " (" << DD(SkillTable["ARMS2"].SkillBase) << ")" << " " << SkillTable["ARMS2"].SubSkillName << std::setw(18-SkillTable["ARMS2"].SkillName.length()-SkillTable["ARMS2"].SubSkillName.length()-Toolong(SkillTable["ARMS2"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["ARMS2"].SkillMod) << "% [ ]" << std::endl;

  //Repair(subskill1)    Spot    Combat Skill(ARMS3)
  std::cout << "  " << SkillTable["Repair1"].SubSkillName << std::setw(22-SkillTable["Repair1"].SubSkillName.length()-Toolong(SkillTable["Repair1"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Repair1"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Spot"].SkillName << " (" << DD(SkillTable["Spot"].SkillBase) << ")" << std::setw(15-Toolong(SkillTable["Spot"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Spot"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["ARMS3"].SkillName << " (" << DD(SkillTable["ARMS3"].SkillBase) << ")" << " " << SkillTable["ARMS3"].SubSkillName << std::setw(18-SkillTable["ARMS3"].SkillName.length()-SkillTable["ARMS3"].SubSkillName.length()-Toolong(SkillTable["ARMS3"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["ARMS3"].SkillMod) << "% [ ]" << std::endl;

  //Slight of Hand    Track    EXPERENCE BONUS
  std::cout << SkillTable["Slight of Hand"].SkillName << " (" << DD(SkillTable["Slight of Hand"].SkillBase) << ")" << std::setw(5-Toolong(SkillTable["Slight of Hand"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Slight of Hand"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Track"].SkillName << " (" << DD(SkillTable["Track"].SkillBase) << ")" << std::setw(14-Toolong(SkillTable["Track"].SkillMod)) << std::setfill('.') << "" << DD(SkillTable["Track"].SkillMod) << "% [ ]" << std::setw(5) << std::setfill(' ') << ""; if(EXPERIENCE_BONUS == true){std::cout << "EXPERENCE BONUS " << DD(ExperenceBonus) << "%"<< std::endl;} else{std::cout << "" << std::endl;}
  //END OF SKILLS
