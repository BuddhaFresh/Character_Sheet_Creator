...
void BRP_human_base::consoleChar()
{
  ...
  std::cout << SkillTable["Persuade"].SkillName << " (" << DD(SkillTable["Persuade"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Persuade"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science1"].SubSkillName << std::setw(22-SkillTable["Science1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science1"].SkillMod) << "%" << "\t\t" << SkillTable["Ride0"].SkillName << " (" << DD(SkillTable["Ride0"].SkillBase) << ")" << "\t" << DD(SkillTable["Ride0"].SkillMod) << "%" << "\t\t" << std::endl;

  //Status    Science(subskill2)    Ride(subskill1)
  std::cout << SkillTable["Status"].SkillName << " (" << DD(SkillTable["Status"].SkillBase) << ")" << std::setw(13) << std::setfill('.') << "" << DD(SkillTable["Status"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science2"].SubSkillName << std::setw(22-SkillTable["Science2"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science2"].SkillMod) << "%" << "\t\t" << SkillTable["BLANK"].SkillName << " (" << DD(SkillTable["BLANK"].SkillBase) << ")" << "\t" << DD(SkillTable["BLANK"].SkillMod) << "%" << "\t\t" << std::endl;

  //Teach    Science(subskill3)    Stealth
  std::cout << SkillTable["Teach"].SkillName << " (" << DD(SkillTable["Teach"].SkillBase) << ")" << std::setw(14) << std::setfill('.') << "" << DD(SkillTable["Teach"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Science3"].SubSkillName << std::setw(22-SkillTable["Science3"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Science3"].SkillMod) << "%" << "\t\t" << SkillTable["Stealth"].SkillName << " (" << DD(SkillTable["Stealth"].SkillBase) << ")" << "\t" << DD(SkillTable["Stealth"].SkillMod) << "%" << "\t\t" << std::endl;

  //BLANK_SPACE    Strategy    Swim
  std::cout << std::setw(32) << std::setfill(' ') << "" << SkillTable["Strategy"].SkillName << " (" << DD(SkillTable["Strategy"].SkillBase) << ")" << std::setw(11) << std::setfill('.') << "" << DD(SkillTable["Strategy"].SkillMod) << "%" << "\t\t" << SkillTable["Swim"].SkillName << " (" << DD(SkillTable["Swim"].SkillBase) << ")" << "\t" << DD(SkillTable["Swim"].SkillMod) << "%" << "\t\t" << std::endl;

  //MANIPULATION    Technical Skill(subskill0)    Throw
  std::cout << "MANIPULATION " << DD(Manipulation_skillcategory) << "%" << std::setw(16) << std::setfill(' ') << "  " << SkillTable["Technical Skill0"].SkillName << " (" << DD(SkillTable["Technical Skill0"].SkillBase) << ")" << " " << SkillTable["Technical Skill0"].SubSkillName << std::setw(9-SkillTable["Technical Skill0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Technical Skill0"].SkillMod) << "%" << "\t\t" << SkillTable["Throw"].SkillName << " (" << DD(SkillTable["Throw"].SkillBase) << ")" << "\t" << DD(SkillTable["Throw"].SkillMod) << "%" << "\t\t" << std::endl;

  //Art(subskill0)    Technical Skill(subskill1)    BLANK_SPACE
  std::cout << SkillTable["Art0"].SkillName << " (" << DD(SkillTable["Art0"].SkillBase) << ")" << " " << SkillTable["Art0"].SubSkillName << std::setw(15-SkillTable["Art0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Art0"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill1"].SubSkillName << std::setw(15) << std::setfill('.') << "" << DD(SkillTable["Technical Skill1"].SkillMod) << "%" << "\t\t" << SkillTable["BLANK"].SkillName << " (" << DD(SkillTable["BLANK"].SkillBase) << ")" << "\t" << DD(SkillTable["BLANK"].SkillMod) << "%" << "\t\t" << std::endl;

  //Art(subskill1)    Technical Skill(subskill2)    COMBAT
  std::cout << "  " << SkillTable["Art1"].SubSkillName << std::setw(22-SkillTable["Art1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Art1"].SkillMod) << "%" << std::setw(7) << std::setfill(' ') << "  " << SkillTable["Technical Skill2"].SubSkillName << std::setw(15) << std::setfill('.') << "" << DD(SkillTable["Technical Skill2"].SkillMod) << "%" << "\t\t" << "COMBAT " << DD(Combat_skillcategory) << "%" << std::endl;

  //Craft(subskill0)    BLANK_SPACE    Dodge
  std::cout << SkillTable["Craft0"].SkillName << " (" << DD(SkillTable["Craft0"].SkillBase) << ")" << " " << SkillTable["Craft0"].SubSkillName << std::setw(13-SkillTable["Craft0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Craft0"].SkillMod) << "%" << std::setw(40) << std::setfill(' ') << SkillTable["Dodge"].SkillName << " (" << DD(SkillTable["Dodge"].SkillBase) << ")" << "\t" << DD(SkillTable["Dodge"].SkillMod) << "%" << "\t\t" << std::endl;

  //Craft(subskill1)    PERCEPTION    Martial Arts
  std::cout << "  " << SkillTable["Craft1"].SubSkillName << std::setw(22-SkillTable["Craft1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Craft1"].SkillMod) << "%" << std::setw(16) << std::setfill(' ') << "PERCEPTION " << DD(Perception_skillcategory) << "%" << "\t" << "\t\t" << SkillTable["Martial Arts"].SkillName << " (" << DD(SkillTable["Martial Arts"].SkillBase) << ")" << "\t" << DD(SkillTable["Martial Arts"].SkillMod) << "%" << "\t\t" << std::endl;

  //Demolition    Insight    TEXT
  std::cout << SkillTable["Demolition"].SkillName << " (" << DD(SkillTable["Demolition"].SkillBase) << ")" << std::setw(9) << std::setfill('.') << "" << DD(SkillTable["Demolition"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Insight"].SkillName << " (" << DD(SkillTable["Insight"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Insight"].SkillMod) << "%" << "\t\t" << "See Weapons below for more Combat skills" << std::endl;

  //Fine Manipulation    Listen
  std::cout << SkillTable["Fine Manipulation"].SkillName << " (" << DD(SkillTable["Fine Manipulation"].SkillBase) << ")" << std::setw(2) << std::setfill('.') << "" << DD(SkillTable["Fine Manipulation"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Listen"].SkillName << " (" << DD(SkillTable["Listen"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Listen"].SkillMod) << "%" << std::endl;

  //Heavy Machine(name)    Navigate    Combat Skill(ARMS0)
  std::cout << SkillTable["Heavy Machine"].SkillName << " (" << DD(SkillTable["Heavy Machine"].SkillBase) << ")" << std::setw(14) << std::setfill(' ') << "" << SkillTable["Navigate"].SkillName << " (" << DD(SkillTable["Navigate"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Navigate"].SkillMod) << "%" << "\t\t" << SkillTable["ARMS0"].SkillName << " (" << DD(SkillTable["ARMS0"].SkillBase) << ")" << "\t" << DD(SkillTable["ARMS0"].SkillMod) << "%" << "\t\t" << std::endl;

  //Heavy Machine(subskill0)    Research    Combat Skill(ARMS1)
  std::cout << "  " << SkillTable["Heavy Machine"].SubSkillName << std::setw(22-SkillTable["Heavy Machine"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Heavy Machine"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Research"].SkillName << " (" << DD(SkillTable["Research"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Research"].SkillMod) << "%" << "\t\t" << SkillTable["ARMS1"].SkillName << " (" << DD(SkillTable["ARMS1"].SkillBase) << ")" << "\t" << DD(SkillTable["ARMS1"].SkillMod) << "%" << "\t\t" << std::endl;

  //Repair(subskill0)    Sense    Combat Skill(ARMS2)
  std::cout << SkillTable["Repair0"].SkillName << " (" << DD(SkillTable["Repair0"].SkillBase) << ")" << "  " << SkillTable["Repair0"].SubSkillName << std::setw(11-SkillTable["Repair0"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Repair0"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Sense"].SkillName << " (" << DD(SkillTable["Sense"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Sense"].SkillMod) << "%" << "\t\t" << SkillTable["ARMS2"].SkillName << " (" << DD(SkillTable["ARMS2"].SkillBase) << ")" << "\t" << DD(SkillTable["ARMS2"].SkillMod) << "%" << "\t\t" << std::endl;

  //Repair(subskill1)    Spot    Combat Skill(ARMS3)
  std::cout << "  " << SkillTable["Repair1"].SubSkillName << std::setw(22-SkillTable["Repair1"].SubSkillName.length()) << std::setfill('.') << "" << DD(SkillTable["Repair1"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Spot"].SkillName << " (" << DD(SkillTable["Spot"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Spot"].SkillMod) << "%" << "\t\t" << SkillTable["ARMS3"].SkillName << " (" << DD(SkillTable["ARMS3"].SkillBase) << ")" << "\t" << DD(SkillTable["ARMS3"].SkillMod) << "%" << "\t\t" << std::endl;

  //Slight of Hand    Track    EXPERENCE BONUS
  std::cout << SkillTable["Slight of Hand"].SkillName << " (" << DD(SkillTable["Slight of Hand"].SkillBase) << ")" << std::setw(5) << std::setfill('.') << "" << DD(SkillTable["Slight of Hand"].SkillMod) << "%" << std::setw(5) << std::setfill(' ') << "" << SkillTable["Track"].SkillName << " (" << DD(SkillTable["Track"].SkillBase) << ")" << std::setw(10) << std::setfill('.') << "" << DD(SkillTable["Track"].SkillMod) << "%" << "\t\t"; if(EXPERIENCE_BONUS == true){std::cout << "EXPERENCE BONUS " << DD(ExperenceBonus) << "%"<< std::endl;} else{std::cout << "" << std::endl;}
  //END OF SKILLS
